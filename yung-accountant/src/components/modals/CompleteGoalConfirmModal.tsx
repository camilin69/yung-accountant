      ...
      <div className="bg-white/[0.03] backdrop-blur-xl border border-white/20 rounded-xl w-full max-w-md overflow-hidden animate-in zoom-in-95 duration-200">
        <div className="flex justify-between items-center p-5 border-b border-white/10">
          <div className="flex items-center gap-3">
            ...
            <h3 className="text-lg font-light text-white">Complete Goal</h3>
          </div>
        ...
        <div className="p-5">
          ...
          <p className="text-white/60 text-sm font-light leading-relaxed mb-4">
                Are you sure you want to complete <span className="text-white font-medium">"{goalName}"</span>?
              </p>
        ...
        <div className="flex gap-3 p-5 border-t border-white/10">
          ...
          <button
            ...
            className="flex-1 px-4 py-2.5 bg-gradient-to-r from-yellow-500 to-orange-600 rounded-lg text-white text-sm font-light transition-all duration-300 hover:scale-[1.02] flex items-center justify-center gap-2"
          >
