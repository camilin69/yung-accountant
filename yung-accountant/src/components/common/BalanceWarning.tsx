...
const BalanceWarning: React.FC<BalanceWarningProps> = ({ amount, walletId, wallets }) => {
  ...
  return (
    <div className="flex items-center gap-2.5 p-3 rounded-2xl glass-sm animate-pulse-subtle"
      ...
      <AlertCircle className="w-4 h-4 flex-shrink-0" style={{ color: 'var(--semantic-expense)' }} strokeWidth={1.5} />
      <p className="text-[12px] font-medium" style={{ color: 'var(--semantic-expense)', opacity: 0.85 }}>
