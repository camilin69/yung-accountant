      ...
      <div className={`flex-shrink-0 ${getHeaderPadding()}`}>
        ...
        <div className="flex items-center justify-between mt-2 mb-2">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className={`${isVerySmall ? 'text-[7px]' : 'text-[9px]'} text-white/30`}>{allSimulations.length} active</span>
          </div>
        </div>
      </div>
        ...
        <div className="bg-white/[0.02] backdrop-blur-sm border border-white/10 rounded-xl overflow-hidden">
          <div className={`${isVerySmall ? 'p-3' : 'p-4'} border-b border-white/10`}>
            <div className={`flex ${isVerySmall ? 'flex-col gap-2' : 'justify-between items-center'}`}>
              ...
              <div className="flex items-center gap-2">
                <button onClick={() => handleSort('createdAt')} className={`px-2 py-1 rounded-lg text-[10px] font-light transition-all duration-200 ${sortBy === 'createdAt' ? 'bg-[#6366F1]/20 text-[#6366F1] border border-[#6366F1]/30' : 'bg-white/5 text-white/60 hover:bg-white/10'}`}>
