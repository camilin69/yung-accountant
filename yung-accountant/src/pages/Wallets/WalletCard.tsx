    ...
    >
      <div className="flex justify-between items-start mb-3">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-base font-light text-[var(--theme-text-primary)]">{wallet.name}</h3>
      ...
      <div className="flex justify-between items-center pt-3 border-t border-[var(--theme-border-light)]">
        <div>
          <span className="text-[10px] text-[var(--theme-text-tertiary)]">Balance</span>
          <p className="text-lg font-light text-[var(--theme-text-primary)]">
            {showBalances ? formatCurrency(wallet.currentBalance) : '••••••'}
          </p>
        </div>
        <div className="text-right">
          <span className="text-[10px] text-[var(--theme-text-tertiary)]">Transactions</span>
          <p className="text-sm font-light text-[var(--theme-text-secondary)]">{transactionCount}</p>
        </div>
      </div>
    </div>
  );
