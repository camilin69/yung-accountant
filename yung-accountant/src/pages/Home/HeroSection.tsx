...
export const HeroSection: React.FC<HeroSectionProps> = ({ 
  ...
  useEffect(() => {
    const handleClickOutside = (event: MouseEvent) => {
      if (
        ...
        roleDropdownRef.current && !roleDropdownRef.current.contains(event.target as Node)
      ) {
  ...
  return (
    <>
        ...
        >
          <div className="flex justify-between items-center gap-3 sm:gap-4 lg:gap-6">
            ...
            <button
              ...
              className="lg:hidden p-2.5 sm:p-3 rounded-2xl transition-all duration-300 hover:scale-110 flex-shrink-0"
      ...
      {/* HERO CONTENT */}
      <section ref={heroRef} className="relative min-h-screen flex items-center justify-center pt-44 sm:pt-48 pb-32 sm:pb-40 overflow-hidden">
