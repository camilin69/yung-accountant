...
export const GoalStats: React.FC<GoalStatsProps> = ({
  ...
  const balanceCards = [
    { icon: <Wallet className="w-5 h-5" style={{ color: 'var(--semantic-info)' }} strokeWidth={1.5} />, label: 'Total Balance', value: formatCurrency(totalBalance), color: '#3B82F6', delay: 0 },
    { icon: <Target className="w-5 h-5" style={{ color: 'var(--semantic-warning)' }} strokeWidth={1.5} />, label: 'In Goals', value: formatCurrency(allocatedToGoals), color: '#F59E0B', delay: 100 },
    { icon: <Sparkles className="w-5 h-5" style={{ color: 'var(--semantic-income)' }} strokeWidth={1.5} />, label: 'Available', value: formatCurrency(availableBalance), color: '#10B981', delay: 200 },
  ];
  ...
  const summaryCards = [
    ...
    { icon: <TrendingUp className="w-4 h-4" style={{ color: 'var(--semantic-income)' }} strokeWidth={1.5} />, label: 'Total Saved', value: formatCurrency(totalSaved), color: 'var(--semantic-income)' },
    { icon: <Sparkles className="w-4 h-4" style={{ color: 'var(--semantic-warning)' }} strokeWidth={1.5} />, label: 'Overall Progress', value: `${overallProgress}%`, color: 'var(--semantic-warning)' },
  ];
